//! UI 样式契约门禁：执行 `core/spec/ui.md` 机检档的 UI-1…UI-8。
//!
...
const APP_CSS: &str = "core/rs/crates/envboard-web/assets/app.css";
const APP_JS: &str = "core/rs/crates/envboard-web/assets/app.js";
const INDEX_HTML: &str = "core/rs/crates/envboard-web/assets/index.html";
const SPEC_MD: &str = "core/spec/ui.md";
